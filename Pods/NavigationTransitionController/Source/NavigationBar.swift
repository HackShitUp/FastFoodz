...
public class NavigationBar: NSObject {
    ...
    public func manageFirstResponder(_ isResigning: Bool) {
        switch isResigning {
        case true:
            // MARK: - TextField
    ...
    public func setTextFieldText(_ text: String?, color: UIColor, font: UIFont) {
    ...
    public func updateTitle(_ titleAttributedString: NSAttributedString) {
        // MARK: - TextField
