...
```
- Classes: Place; LocalError; MainData; ShareContext
- Factories: YelpFactory
- Keys
- Style
- ViewControllers: DetailViewController; MainNavigationController; MainViewController; MapListViewController; MapViewController
- Views: Storyboard; UICollectionReusableView; UICollectionViewCell; UICollectionViewFlowLayout; UIView
```
